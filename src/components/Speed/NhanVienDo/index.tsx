...
const RoleList = (props: Props) => {  
    ...
    const DialogMemo = useMemo(() => {
        return <>
        {dialogVisible == true ?
            <CtrlDialog style={{width:"60%"}} title={roleId ? "Sửa nhân viên đo": "Tạo mới nhân viên đo"} dialogVisible={dialogVisible} onCancel={() => setDialogVisible(false)}>
    ...
    return(
        <>
            <CtrlConfirm ref={refConfirm_DeleteItem} Title="Thao tác này sẽ xóa nhân viên đo" Ok={async () => {await DeleteById()}} Canel={()=>{}} />
